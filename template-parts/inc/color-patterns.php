 ...
 */
function kcs_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Anna R Pack default saturation level.
	 *
	 *  
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'kcs_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.kcs-front-page) .entry-title,
...
.colors-custom .kcs-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.kcs-front-page .panel-content .recent-posts article,
...
.colors-custom.kcs-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Anna R Pack custom colors CSS.
	 *
	 *  
	 *
	 ...
	 */
	return apply_filters( 'kcs_custom_colors_css', $css, $hue, $saturation );
}
